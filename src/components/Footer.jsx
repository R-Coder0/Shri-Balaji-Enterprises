      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul>
              <li>
                <a href="/" className="text-lg text-gray-200 hover:text-white transition duration-300">Home</a>
              </li>
              <li>
                <a href="/about" className="text-lg text-gray-200 hover:text-white transition duration-300">About</a>
              </li>
              <li>
                <a href="/gallery" className="text-lg text-gray-200 hover:text-white transition duration-300">Gallery</a>
              </li>
              <li>
                <a href="/contact" className="text-lg text-gray-200 hover:text-white transition duration-300">Contact</a>
              </li>
            </ul>
          </div>
