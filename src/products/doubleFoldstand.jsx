        ...
        <div>
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold mb-4">Double Fold Cloth Drying Stand</h1>
                    <nav className="flex justify-center items-center space-x-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <span className="text-white">Double Fold Cloth Drying Stand</span>
                    </nav>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6  flex items-center justify-center">
                        <img
                            src={productImage}
                            alt="Double Fold Cloth Drying Stand"
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 ">
                        ...
                        <p className="text-gray-700 mb-4">
                            Shri Balaji Enterprises brings you the <strong>Double Fold Cloth Drying Stand</strong>, a perfect blend of elegance and functionality for your laundry needs. Designed to meet the modern household&apos;s requirements, this drying stand is an excellent choice for convenient and organized drying of clothes. Its sleek white finish adds a touch of sophistication to your home.
                        </p>
                        <p className="text-gray-700 mb-4">
                            Made with top-quality stainless steel and coated with a premium white finish, the Double Fold Cloth Drying Stand offers excellent durability and style. Its anti-corrosion properties make it ideal for long-term use, even in humid environments. The foldable and space-saving design ensures it fits seamlessly into your lifestyle, whether indoors or outdoors.
                        </p>
                        ...
                        <p className="text-gray-700">
                            Upgrade your laundry experience with the <strong>Double Fold Cloth Drying Stand</strong>. Trust Shri Balaji Enterprises for products that combine innovative design, exceptional quality, and practical solutions for everyday needs. Choose a product that makes your life easier and your home more organized.
                        </p>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
                <div className="bg-white rounded-lg shadow-md p-6 ">
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Double Fold Cloth Drying Stand Price and Quantity</h3>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Double Fold Cloth Drying Stand Product Specifications</h3>
                    <table className="w-full text-left border-collapse mb-6">
                        <tbody>
                            <tr>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Double Fold Cloth Drying Stand Trade Information</h3>
                    <table className="w-full text-left border-collapse">
                        <tbody>
                            <tr>
...
export default DoubleFoldstand;
