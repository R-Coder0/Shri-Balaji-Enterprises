...
import productImage from '../assets/product/DSC02710 copy.jpg'
  ...
  >
    <div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <nav className="flex justify-center items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-white">Sumo Steel Cloth Drying Stand</span>
          </nav>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Sumo Steel Cloth Drying Stand</strong>, a perfect blend
              of elegance and functionality for your laundry needs. Designed to
              meet the modern household&apos;s requirements, this drying stand
              is an excellent choice for convenient and organized drying of
              clothes. Its sleek white finish adds a touch of sophistication to
              your home.
            </p>
            <p className="text-gray-700 mb-4">
              Made with top-quality stainless steel and coated with a premium
              white finish, the Sumo Steel Cloth Drying Stand offers excellent
              durability and style. Its anti-corrosion properties make it ideal
              for long-term use, even in humid environments. The foldable and
              space-saving design ensures it fits seamlessly into your
              lifestyle, whether indoors or outdoors.
            </p>
            ...
            <p className="text-gray-700">
              ...
              <strong>Sumo Steel Cloth Drying Stand</strong>. Trust Shri Balaji
              Enterprises for products that combine innovative design,
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">Sumo Steel</h3>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <button
              className="w-full md:w-auto bg-red-600 text-white border border-red-600 hover:text-red-600 py-3 px-6 hover:bg-transparent transition duration-300"
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Sumo Steel Cloth Drying Stand Price and Quantity
          </h3>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Sumo Steel Cloth Drying Stand Trade Information
          </h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
