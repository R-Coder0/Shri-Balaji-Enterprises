...
import productImage from "../assets/product/DSC02702.jpg"; // Replace with your product image path
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Super Jumbo White Cloth Drying Stand</strong>, a perfect
            ...
            <p className="text-gray-700 mb-4">
              ...
              white finish, the Super Jumbo White Cloth Drying Stand offers
            ...
            <p className="text-gray-700">
              ...
              <strong>Super Jumbo White Cloth Drying Stand</strong>. Trust Shri
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Super Jumbo White Cloth Drying Stand Price and Quantity
          </h3>
          ...
          {/* <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Super Jumbo Cloth Drying Stand Product Specifications
          </h3>
          <table className="w-full text-left border-collapse mb-6">
            <tbody>
              <tr>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Super Jumbo White Cloth Drying Stand Trade Information
          </h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
