...
import productImage from '../assets/product/DSC02697.jpg'
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <nav className="flex justify-center items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-white">Sumo White Cloth Drying Stand</span>
          </nav>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Sumo White Cloth Drying Stand</strong>, a perfect blend
            ...
            <p className="text-gray-700 mb-4">
              ...
              white finish, the Sumo White Cloth Drying Stand offers excellent
            ...
            <p className="text-gray-700">
              ...
              <strong>Sumo White Cloth Drying Stand</strong>. Trust Shri Balaji
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">Sumo White</h3>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <button
              className="w-full md:w-auto bg-red-600 text-white border border-red-600 py-3 px-6 hover:bg-transparent hover:text-red-600 transition duration-300"
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Sumo White Cloth Drying Stand Price and Quantity
          </h3>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Sumo White Cloth Drying Stand Trade Information
          </h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
