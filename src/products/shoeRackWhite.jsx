...
import productImage from "../assets/product/DSC02791 copy.jpg"; // Replace with your product image path
      ...
      <div>
        ...
        >
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-bold mb-4">Shoe Rack White</h1>
            <nav className="flex justify-center items-center space-x-2 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-white">Shoe Rack White</span>
            </nav>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 ">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <strong>Shoe Rack White</strong> , an ideal storage solution for
                keeping your footwear organized and easily accessible. Designed
                for modern homes, this shoe rack enhances space efficiency while
                adding a touch of elegance to your interiors.
              </p>
              <p className="text-gray-700 mb-4">
                Built with high-quality stainless steel, this rack ensures
                durability, rust resistance, and long-lasting performance. The
                multi-tier structure provides ample space for shoes, sandals,
                and other footwear, making it a perfect addition to your home,
                office, or commercial spaces.
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li>
                  High-quality stainless steel construction with anti-rust
                  coating
                </li>
              ...
              <p className="text-gray-700">
                Upgrade your shoe storage with the{" "}
                <strong>Shoe Rack White</strong>. Shri Balaji Enterprises
                guarantees top-notch quality, innovative designs, and value for
                money. Keep your space neat and stylish with this must-have
                footwear organizer.
              </p>
            </div>
          </div>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
          <div className="bg-white rounded-lg shadow-md p-6 ">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Shoe Rack White Price and Quantity
            </h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Shoe Rack White Trade Information
            </h3>
            <table className="w-full text-left border-collapse">
              <tbody>
                <tr>
