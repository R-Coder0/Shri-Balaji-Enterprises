...
import productImage from "../assets/Stainless-Steel-Cloth-Drying-Stand.webp"; // Replace with your product image path
import heroBackground from "../assets/hero1.jpg";
import RequestForm from "../components/RequestForm";
import RequestCallForm from "../components/RequestCallForm";
import '../styles/product.css'

const SuperJumboSteelClothDryingStand = () => {
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold mb-4">Super Jumbo Steel Cloth Drying Stand</h1>
          <nav className="flex justify-center items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-white">Super Jumbo Steel Cloth Drying Stand</span>
          </nav>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6  flex items-center justify-center">
            <img
              src={productImage}
              alt="Super Jumbo Steel Cloth Drying Stand"
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Super Jumbo Steel Cloth Drying Stand
            </h2>
            <p className="text-gray-700 mb-4">
              Shri Balaji Enterprises brings you the ultimate solution for your laundry needs with the <strong>Super Jumbo Steel Cloth Drying Stand</strong>. This innovative product is designed to combine functionality, durability, and elegance, catering to the modern-day needs of every household. Whether you have a small apartment or a spacious home, this drying stand is the perfect companion for hassle-free drying.
            </p>
            <p className="text-gray-700 mb-4">
              Manufactured with premium-quality stainless steel, the drying stand boasts exceptional strength and a sleek design. Its anti-corrosion coating ensures longevity, even in humid environments, making it an ideal choice for both indoor and outdoor use. With its compact and foldable design, the stand can be easily stored when not in use, saving valuable space in your home.
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>Durable stainless steel construction with a protective anti-corrosion coating</li>
              <li>Compact, foldable design for effortless storage and portability</li>
              <li>Multiple tiers for drying a variety of clothes and fabrics</li>
              <li>Sturdy base with anti-slip caps for enhanced stability</li>
              <li>Rust-resistant material for long-lasting performance</li>
              <li>Perfect for both indoor and outdoor drying</li>
            </ul>
            <p className="text-gray-700">
              Choose Shri Balaji Enterprises for products that reflect superior craftsmanship and thoughtful design. With the Super Jumbo Steel Cloth Drying Stand, you get the perfect combination of style, functionality, and long-term value, enhancing your everyday life in more ways than one.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          ...
          <p className="text-xl text-red-600 font-bold mb-4 font-montserrat">1800.0 INR/Unit</p>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6  font-montserrat">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 font-montserrat">Super Jumbo Cloth Drying Stand Price and Quantity</h3>
          <table className="w-full text-left border-collapse mb-6">
            <tbody>
              <tr>
                <td className="border-b border-gray-300 py-2 pr-4 font-medium text-gray-800">Price</td>
                <td className="border-b border-gray-300 py-2 text-gray-600">1800.0 INR/Unit</td>
              </tr>
              <tr>
                <td className="border-b border-gray-300 py-2 pr-4 font-medium text-gray-800">Weight</td>
                <td className="border-b border-gray-300 py-2 text-gray-600">8 Kg</td>
              </tr>
              <tr>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">Super Jumbo Cloth Drying Stand Product Specifications</h3>
          <table className="w-full text-left border-collapse mb-6">
            <tbody>
              <tr>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">Super Jumbo Cloth Drying Stand Trade Information</h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
    ...
    {/* FAQs */}
    <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
      <h2 className="text-3xl font-bold text-gray-900 text-center mb-8 font-montserrat">Frequently Asked Questions</h2>
...
export default SuperJumboSteelClothDryingStand;