...
import productImage from "../assets/product/ladder.jpg"; // Replace with your product image path
    ...
    >
      <div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <nav className="flex justify-center items-center space-x-2 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-white">Aluminium Ladder plastic top</span>
            </nav>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
              <img
                src={productImage}
                alt="Aluminium Ladder plastic top"
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700 mb-4">
                Shri Balaji Enterprises presents the{" "}
                <strong>Aluminium Ladder Plastic Top</strong>, a sturdy and
                reliable ladder designed for various household and industrial
                purposes. Crafted with high-quality aluminium, this ladder
                ensures safety, durability, and ease of use.
              </p>
              <p className="text-gray-700 mb-4">
                Featuring a plastic top for added grip and stability, this
                ladder is lightweight yet strong, making it perfect for home
                maintenance, painting, repairs, and other tasks that require
                elevation. The anti-skid steps and robust structure provide
                enhanced security and convenience.
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li>
                  High-quality aluminium frame for lightweight and sturdy
                  performance
                </li>
                <li>Plastic top platform for added grip and comfort</li>
                <li>Anti-slip steps for enhanced safety</li>
                <li>Foldable and compact design for easy storage</li>
                <li>Rust-resistant and long-lasting build</li>
                <li>Ideal for home, office, and industrial use</li>
              </ul>
              <p className="text-gray-700">
                Elevate your accessibility with the{" "}
                <strong>Aluminium Ladder Plastic Top</strong> from Shri Balaji
                Enterprises. Experience unmatched quality, innovative design,
                and ultimate convenience. Whether for household tasks or
                professional use, this ladder is a must-have addition to your
                tools.
              </p>
            </div>
          </div>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
          <div className="bg-white rounded-lg shadow-md p-6 ">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Aluminium Ladder plastic top Price and Quantity
            </h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Aluminium Ladder plastic top Trade Information
            </h3>
            <table className="w-full text-left border-collapse">
              <tbody>
                <tr>
