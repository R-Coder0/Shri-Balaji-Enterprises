...
import productImage from "../assets/product/DSC02720 copy.jpg"; // Replace with your product image path
  ...
  >
    <div>
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold mb-4">
            Hard Rock Heavy Rods Cloth Drying Stand
          </h1>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
            <img
              src={productImage}
              alt="Hard Rock Heavy Rods Cloth Drying Stand"
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Hard Rock Heavy Rods Cloth Drying Stand</strong>, the
              ultimate solution for your laundry needs. Engineered for modern
              households, this innovative drying stand seamlessly combines
              style, durability, and practicality. Whether you live in a compact
              apartment or a large home, this drying stand is designed to make
              drying clothes hassle-free and efficient.
            </p>
            <p className="text-gray-700 mb-4">
              Crafted with premium-grade stainless steel, the Hard Rock Heavy Rods
              Cloth Drying Stand offers unmatched strength and stability. Its
              anti-corrosion coating ensures a long-lasting shine and superior
              performance, even in humid conditions. The foldable and compact
              design makes it ideal for easy storage, saving you valuable space
              when not in use.
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
                Robust stainless steel construction with anti-corrosion
                protection
              </li>
              <li>
                Compact and foldable design for convenient storage and
                portability
              </li>
              <li>
                Multiple tiers for drying clothes, towels, and other fabrics
              </li>
              <li>
                Anti-slip caps on the base for enhanced stability and safety
              </li>
              <li>Resilient material designed for long-lasting use</li>
              <li>Suitable for both indoor and outdoor drying needs</li>
            </ul>
            <p className="text-gray-700">
              Elevate your laundry experience with the{" "}
              <strong>Hard Rock Heavy Rods Cloth Drying Stand</strong>. Choose
              Shri Balaji Enterprises for products that offer superior
              craftsmanship, innovative design, and exceptional value. Enhance
              your home with a product that&apos;s built to last and designed to
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <button
              className="w-full md:w-auto bg-red-600 border border-red-600 text-white py-3 px-6 hover:bg-transparent hover:text-red-600 transition duration-300"
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
          Hard Rock Heavy Rods Cloth Drying Stand Price and Quantity
          </h3>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Hard Rock Heavy Rods with Wheel Cloth Drying Stand Trade Information
          </h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
