...
import productImage from "../assets/product/DSC02710 copy.jpg"; // Replace with your product image path
  ...
  >
    <div>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
            <img
              src={productImage}
              alt="Sky High Cloth Drying Stand"
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Sky High Cloth Drying Stand</strong>, the
            ...
            <p className="text-gray-700 mb-4">
              Crafted with premium-grade stainless steel, the Sky High
            ...
            <p className="text-gray-700">
              ...
              <strong>Sky High Cloth Drying Stand</strong>. Choose
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
        <div className="bg-white rounded-lg shadow-md p-6 ">
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
          Sky High Cloth Drying Stand Price and Quantity
          </h3>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Sky High Cloth Drying Stand Trade Information
          </h3>
          <table className="w-full text-left border-collapse">
            <tbody>
              <tr>
