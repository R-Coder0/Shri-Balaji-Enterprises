...
import productImage from "../assets/product/PrinceJumboSteel.jpg"; // Replace with your product image path
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
            <img
              src={productImage}
              alt="Prince Jumbo Steel Cloth Drying Stand"
          ...
          <div className="bg-white rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <strong>Prince Jumbo Steel Cloth Drying Stand</strong>, the
            ...
            <p className="text-gray-700 mb-4">
              Crafted with premium-grade stainless steel, the Prince Jumbo Steel
            ...
            <p className="text-gray-700">
              ...
              <strong>Prince Jumbo Steel Cloth Drying Stand</strong>. Choose
