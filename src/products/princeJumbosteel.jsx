...
import productImage from "../assets/Products/product2.jpg"; // Replace with your product image path
import heroBackground from "../assets/hero1.jpg";
import RequestForm from "../components/RequestForm";
import RequestCallForm from "../components/RequestCallForm";
import '../styles/product.css'

const PrinceJumbosteel = () => {
        ...
        <div>
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold mb-4">Prince Jumbo Steel Cloth Drying Stand</h1>
                    <nav className="flex justify-center items-center space-x-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <span className="text-white">Prince Jumbo Steel Cloth Drying Stand</span>
                    </nav>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 ">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">
                            Prince Jumbo Steel Cloth Drying Stand
                        </h2>
                        <p className="text-gray-700 mb-4">
                            Shri Balaji Enterprises introduces the <strong>Prince Jumbo Steel Cloth Drying Stand</strong>, the ultimate solution for your laundry needs. Engineered for modern households, this innovative drying stand seamlessly combines style, durability, and practicality. Whether you live in a compact apartment or a large home, this drying stand is designed to make drying clothes hassle-free and efficient.
                        </p>
                        <p className="text-gray-700 mb-4">
                            Crafted with premium-grade stainless steel, the Prince Jumbo Steel Cloth Drying Stand offers unmatched strength and stability. Its anti-corrosion coating ensures a long-lasting shine and superior performance, even in humid conditions. The foldable and compact design makes it ideal for easy storage, saving you valuable space when not in use.
                        </p>
                        <ul className="list-disc pl-6 text-gray-700 mb-4">
                            <li>Robust stainless steel construction with anti-corrosion protection</li>
                            <li>Compact and foldable design for convenient storage and portability</li>
                            <li>Multiple tiers for drying clothes, towels, and other fabrics</li>
                            <li>Anti-slip caps on the base for enhanced stability and safety</li>
                            <li>Resilient material designed for long-lasting use</li>
                            <li>Suitable for both indoor and outdoor drying needs</li>
                        </ul>
                        <p className="text-gray-700">
                            Elevate your laundry experience with the <strong>Prince Jumbo Steel Cloth Drying Stand</strong>. Choose Shri Balaji Enterprises for products that offer superior craftsmanship, innovative design, and exceptional value. Enhance your home with a product that&apos;s built to last and designed to fit seamlessly into your lifestyle.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
                <div className="bg-white rounded-lg shadow-md p-6 ">
                    ...
                    <p className="text-xl text-red-600 font-bold mb-4">1650.0 INR/Unit</p>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
                <div className="bg-white rounded-lg shadow-md p-6 ">
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Super Jumbo Cloth Drying Stand Price and Quantity</h3>
                    <table className="w-full text-left border-collapse mb-6">
                        <tbody>
                            <tr>
                                <td className="border-b border-gray-300 py-2 pr-4 font-medium text-gray-800">Price</td>
                                <td className="border-b border-gray-300 py-2 text-gray-600">1650.0 INR/Unit</td>
                            </tr>
                            <tr>
                                <td className="border-b border-gray-300 py-2 pr-4 font-medium text-gray-800">Weight</td>
                                <td className="border-b border-gray-300 py-2 text-gray-600">7.5 Kg</td>
                            </tr>
                            <tr>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Prince Jumbo Cloth Drying Stand Product Specifications</h3>
                    <table className="w-full text-left border-collapse mb-6">
                        <tbody>
                            <tr>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Prince Jumbo Cloth Drying Stand Trade Information</h3>
                    <table className="w-full text-left border-collapse">
                        <tbody>
                            <tr>
...
export default PrinceJumbosteel;
