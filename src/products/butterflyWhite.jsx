...
import productImage from "../assets/product/DSC02750 copy.jpg"; // Replace with your product image path
    ...
    >
      <div>
        ...
        >
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-bold mb-4">
              Butterfly White Cloth Drying Stand
            </h1>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
              <img
                src={productImage}
                alt="Butterfly White  Steel Cloth Drying Stand"
            ...
            <div className="bg-white rounded-lg shadow-md p-6 ">
              ...
              <p className="text-gray-700 mb-4">
                ...
                , the ultimate solution for your laundry needs. Engineered for
                modern households, this innovative drying stand seamlessly
                combines style, durability, and practicality. Whether you live
                in a compact apartment or a large home, this drying stand is
                designed to make drying clothes hassle-free and efficient.
              </p>
              <p className="text-gray-700 mb-4">
                Crafted with premium-grade stainless steel, the Full Steel
                ButterFly  Steel Cloth Drying Stand offers unmatched
                strength and stability. Its anti-corrosion coating ensures a
                long-lasting shine and superior performance, even in humid
                conditions. The foldable and compact design makes it ideal for
                easy storage, saving you valuable space when not in use.
              </p>
              ...
              <p className="text-gray-700">
                ...
                . Choose Shri Balaji Enterprises for products that offer
                superior craftsmanship, innovative design, and exceptional
                value. Enhance your home with a product that&apos;s built to
                last and designed to fit seamlessly into your lifestyle.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
          <div className="bg-white rounded-lg shadow-md p-6 ">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
            Butterfly White Cloth Drying Stand Price and Quantity
            </h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Butterfly White  Cloth Drying Stand Trade
              Information
            </h3>
            <table className="w-full text-left border-collapse">
              <tbody>
