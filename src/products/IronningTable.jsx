...
import productImage from "../assets/product/IrroningTable.webp"; // Replace with your product image path
    ...
    >
      <div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <nav className="flex justify-center items-center space-x-2 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-white">Ironing Wooden Board</span>
            </nav>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <strong>Ironing Wooden Board</strong>, a sturdy and
              ...
              <p className="text-gray-700">
                ...
                <strong>Ironing Wooden Board</strong> from Shri Balaji
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
          <div className="bg-white rounded-lg shadow-md p-6 ">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Ironing Wooden Board Price and Quantity
            </h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">
              Ironing Wooden Board Trade Information
            </h3>
            <table className="w-full text-left border-collapse">
              <tbody>
                <tr>
