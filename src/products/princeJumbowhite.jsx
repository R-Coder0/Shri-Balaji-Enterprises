...
import productImage from "../assets/Home/service3.jpg"; // Replace with your product image path
        ...
        <div>
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold mb-4">Prince Jumbo White Cloth Drying Stand</h1>
                    <nav className="flex justify-center items-center space-x-2 text-sm">
                        ...
                        <span className="text-gray-400">/</span>
                        <span className="text-white">Prince Jumbo White Cloth Drying Stand</span>
                    </nav>
                </div>
            </section>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-8 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6  flex items-center justify-center">
                        <img
                            src={productImage}
                            alt="Prince Jumbo White Cloth Drying Stand"
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 ">
                        ...
                        <p className="text-gray-700 mb-4">
                            Shri Balaji Enterprises brings you the <strong>Prince Jumbo White Cloth Drying Stand</strong>, a perfect blend of elegance and functionality for your laundry needs. Designed to meet the modern household&apos;s requirements, this drying stand is an excellent choice for convenient and organized drying of clothes. Its sleek white finish adds a touch of sophistication to your home.
                        </p>
                        <p className="text-gray-700 mb-4">
                            Made with top-quality stainless steel and coated with a premium white finish, the Prince Jumbo White Cloth Drying Stand offers excellent durability and style. Its anti-corrosion properties make it ideal for long-term use, even in humid environments. The foldable and space-saving design ensures it fits seamlessly into your lifestyle, whether indoors or outdoors.
                        </p>
            ...
            <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10">
                <div className="bg-white rounded-lg shadow-md p-6 ">
                    <h3 className="text-2xl font-bold text-gray-900 mb-6">Prince Jumbo Cloth Drying Stand Price and Quantity</h3>
